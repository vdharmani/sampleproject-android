...
import com.sample.app.core.network.interceptor.AuthInterceptor
import com.sample.app.core.network.interceptor.TokenRefreshAuthenticator
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideOkHttpClient(auth: AuthInterceptor, authenticator: TokenRefreshAuthenticator): OkHttpClient {
