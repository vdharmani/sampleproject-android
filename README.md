...
- Security hardening: HTTPS-only (network security config blocks cleartext), `allowBackup` disabled (+ device-transfer exclusion for the token store), bearer headers never logged in release
